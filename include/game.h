...
entity_t *create_entity(sfSprite *sprite, sfTexture *texture,
    dictionary_t *animations);
void destroy_entities(dictionary_t *entities);
...
dictionary_t *load_entities(linked_list_t *obj);
void parse_hitbox(entity_t *e, json_object_t *obj);
linked_list_t *check_entity_coll(entity_t *e1, entity_t *e2);
linked_list_t *check_layer_collision(entity_t *e, layer_t *layer);
linked_list_t *check_all_collisions(entity_t *e, char *name, dictionary_t *entities,
